...
```{r GENERATE THE CONFUSION MATRIX ON THE BEST SUBSET OF FEATURES, echo=FALSE}
## Next steps
...
```{r SUPERLEARNER-SL FUNCTION CALL that generates SL objects, echo=FALSE, , echo=FALSE}
# 
...
```{r Generate the confusion matrix, echo=FALSE}
truth=Ypred; # set the true outcome to be predicted
