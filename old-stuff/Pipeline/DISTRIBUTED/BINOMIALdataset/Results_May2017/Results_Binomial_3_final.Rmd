---
title: "CBDA-SL and Knockoff Filter Results on the Binomial Dataset - n=300 p=900, 9000 jobs x 6 experiment - MSE and Accuracy as ranking metrics for the CBDA"
...
# Binomial_dataset_3_new = read.csv("C:/Users/simeonem/Documents/CBDA-SL/ExperimentsNov2016/Binomial/Binomial_5/Binomial_dataset_3.txt",header = TRUE)
...
#label=c("Binomial_dataset_3_new")
label=c("Binomial_dataset_3_final")
...
eval(parse(text=paste0("save(arguments,workspace_directory,list_exps,label,file= \"~/temp_Binomial_dataset_3_new.RData\")")))
#print(getwd())
```
...
eval(parse(text=paste0("Binomial_dataset_3_new_exp_",i,"<-qa")))
...
eval(parse(text=paste0("save(Binomial_dataset_3_new_exp_",i,",arguments,workspace_directory,list_exps,label,file= \"Binomial_dataset_3_new_exp_",i,".RData\")")))
# print(q)
rm(list = ls())
eval(parse(text=paste0("load(\"~/temp_Binomial_dataset_3_new.RData\")")))
cat("\n\n\n\n\n\n")
}
```
...
eval(parse(text=paste0("load(\"~/temp_Binomial_dataset_3_new.RData\")")))
Binomial_dataset_3_new_ALL <- NULL
for (i in list_exps) {
  eval(parse(text=paste0("load(\"Binomial_dataset_3_new_exp_",i,".RData\")")))
  eval(parse(text=paste0("Binomial_dataset_3_new_ALL <- rbind(Binomial_dataset_3_new_ALL,Binomial_dataset_3_new_exp_",i,")")))
}
eval(parse(text=paste0("save(Binomial_dataset_3_new_ALL,arguments,workspace_directory,list_exps,label,file= \"Binomial_dataset_3_new_exps_combined.RData\")")))
...
Binomial_dataset_3_new_ALL_temp <- Binomial_dataset_3_new_ALL[with(Binomial_dataset_3_new_ALL, order(-Density, CBDA)), ];
names(Binomial_dataset_3_new_ALL_temp)[3]<-c("DensityCBDA")
names(Binomial_dataset_3_new_ALL_temp)[5]<-c("DensityKO")
BEST <- 15
w1 <- c(1:BEST)
w2 <- c(1:BEST)

Binomial_dataset_3_new_ALL_temp$CBDA <- as.numeric(as.character(Binomial_dataset_3_new_ALL_temp$CBDA))

#print(c(Binomial_5_new_ALL_temp$CBDA[w1],Binomial_5_new_ALL_temp$Knockoff[w2]))

a10 <- unique(c(Binomial_dataset_3_new_ALL_temp$CBDA[w1],Binomial_dataset_3_new_ALL_temp$Knockoff[w2]))
print("Top Features Selected across multiple experiments,shared between CBDA-SL and Knockoff filter")
print(a10)


# dataset_file=c("Binomial_dataset_3.txt")
