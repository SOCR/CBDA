---
title: "CBDA-SL and Knockoff Filter Results on the Binomial Dataset - n=300 p=1500, 9000 jobs x 8 experiment - MSE and Accuracy as ranking metrics for CBDA"
...
# Null_dataset_new = read.csv("C:/Users/simeonem/Documents/CBDA-SL/ExperimentsNov2016/Null/Null_5/Null_dataset_5.txt",header = TRUE)
...
save(arguments,workspace_directory,list_exps,label,file= "C:/Users/simeonem/Documents/CBDA-SL/ExperimentsNov2016/Binomial9000/Jiachen/finalRData/temp_Binomial_dataset_5_final.RData")
#print(getwd())
```
...
print(nonzero)
eval(parse(text=paste0("Binomial_dataset_5_final_exp_",i,"<-qa_ALL")))
...
eval(parse(text=paste0("save(Binomial_dataset_5_final_exp_",i,",arguments,workspace_directory,list_exps,label,qa_ALL,k_top_",top,"_temp_Accuracy,k_top_",top,"_temp,k_top_",top,"_temp_exp_",i,",k_top_",top,"_temp_Accuracy_exp_",i,",KO_sub_exp_",i,", file= \"Binomial_dataset_5_final_exp_",i,".RData\")")))
# print(q)
rm(list = ls())
eval(parse(text=paste0("load(\"C:/Users/simeonem/Documents/CBDA-SL/ExperimentsNov2016/Binomial9000/Jiachen/finalRData/temp_Binomial_dataset_5_final.RData\")")))
cat("\n\n\n\n\n\n")
}
```
...
for (i in list_exps)
  {
  eval(parse(text=paste0("load('Binomial_dataset_5_final_exp_",i,".RData')")))
