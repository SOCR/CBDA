---
title: "CBDA-SL and Knockoff Filter Results on the Binomial Dataset - n=300 p=900, 9000 jobs x 6 experiment - MSE and Accuracy as ranking metrics for CBDA"
...
save(arguments,workspace_directory,list_exps,label,file= "C:/Users/simeonem/Documents/CBDA-SL/ExperimentsNov2016/Binomial9000/Jiachen/finalRData/temp_Binomial_dataset_3_final.RData")
#print(getwd())
```
...
print(nonzero)
eval(parse(text=paste0("Binomial_dataset_3_final_exp_",i,"<-qa_ALL")))
...
eval(parse(text=paste0("save(Binomial_dataset_3_final_exp_",i,",arguments,workspace_directory,list_exps,label,qa_ALL,k_top_",top,"_temp_Accuracy,k_top_",top,"_temp,k_top_",top,"_temp_exp_",i,",k_top_",top,"_temp_Accuracy_exp_",i,",KO_sub_exp_",i,", file= \"Binomial_dataset_3_final_exp_",i,".RData\")")))
# print(q)
rm(list = ls())
eval(parse(text=paste0("load(\"C:/Users/simeonem/Documents/CBDA-SL/ExperimentsNov2016/Binomial9000/Jiachen/finalRData/temp_Binomial_dataset_3_final.RData\")")))
cat("\n\n\n\n\n\n")
}
```
...
for (i in list_exps)
  {
  eval(parse(text=paste0("load('Binomial_dataset_3_final_exp_",i,".RData')")))
