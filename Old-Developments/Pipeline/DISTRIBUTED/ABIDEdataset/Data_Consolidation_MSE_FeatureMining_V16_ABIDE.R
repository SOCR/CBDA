...
# This is from the Initialization script
...
eval(parse(text=paste0("load(\"~/temp_data_info_ABIDE.RData\")")))
#eval(parse(text=paste0("load(\"~/temp_data_info",label,".RData\")")))
#eval(parse(text=paste0("save(arguments,label,workspace_directory,i_exp,file= \"~a/temp_dat_info_",label,".RData\")")))
